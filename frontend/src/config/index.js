...
export const courseCategories = [
  { id: "web-development", label: "Web Development", icon: "Layout" },
  { id: "backend-development", label: "Backend Development", icon: "Database" },
  { id: "data-science", label: "Data Science", icon: "BarChart4" },
  ...
  { id: "software-engineering", label: "Software Engineering", icon: "Layers" },
];
